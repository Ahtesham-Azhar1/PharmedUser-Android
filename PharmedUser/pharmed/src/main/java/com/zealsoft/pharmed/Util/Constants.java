...
//    public static final String SERVER_IP = "http://10.2.1.167:3000/";
    ...
    public static final String AUTH_CODE_TAG_SP = "PD_AUTH_CODE_TAG_SP";
    public static final String INSTALL_EVENT_TAG_SP = "PD_INSTALL_EVENT_TAG_SP";
    public static final String PHARMACY_DATA_TAG_SP = "PD_PHARMACY_DATA_TAG_SP";
    public static final String USER_DATA_TAG_SP = "PD_USER_DATA_TAG_SP";
    public static final String PHARMACY_IMAGE_TAG_SP = "PD_PHARMACY_IMAGE_TAG_SP";
    public static final String NIGHT_MODE_TAG_SP = "PD_NIGHT_MODE_TAG_SP";
    public static final String LOCATION_TAG_SP = "PD_LOCATION_TAG_SP";
    public static final String NEARBY_PHARMACIES_TAG_SP_OLD = "PD_NEARBY_PHARMACIES_TAG_SP_OLD";
    public static final String NEARBY_PHARMACIES_TAG_SP = "PD_NEARBY_PHARMACIES_TAG_SP";
    public static final String CART_UPDATE_TAG_SP = "PD_CART_UPDATE_TAG_SP";
    public static final String CART_LIST_TAG_SP = "PD_CART_LIST_TAG_SP";
    public static final String CART_MESSAGE_TAG_SP = "PD_CART_MESSAGE_TAG_SP";
    public static final String SELECTED_PHARMACY_TAG_SP = "PD_SELECTED_PHARMACY_TAG_SP";
    public static final String MOVE_FIND_DATA_TAG_SP = "PD_MOVE_FIND_DATA_TAG_SP";
    public static final String PHARMACIES_ACTION_TAG_SP = "PD_PHARMACIES_ACTION_TAG_SP";
    public static final String FCM_TOKEN_TAG_SP = "PD_FCM_TOKEN_SP";
    public static final String FCM_TOKEN_SENT_TAG_SP = "PD_FCM_TOKEN_SENT_SP";
    public static final String NOTIFICATIONS_ON_OFF_TAG_SP = "PD_NOTIFICATIONS_ON_OFF_TAG_SP";
    public static final String VOICE_OVER_ON_OFF_TAG_SP = "PD_VOICE_OVER_ON_OFF_TAG_SP";
    public static final String PRESCRIPTION_IMAGE_TAG_SP = "PD_PRESCRIPTION_IMAGE_TAG_SP";
    public static final String NOTIFICATION_TUNE_TAG_SP = "PD_NOTIFICATION_TUNE_TAG_SP";
    public static final String FIRST_INSTALL_TAG_SP = "PD_FIRST_INSTALL_TAG_SP";
    public static final String ORDER_COUNT_TAG_SP = "PD_ORDER_COUNT_TAG_SP";
    public static final String ORDER_COUNT_CHANGE_TAG_SP = "PD_ORDER_COUNT_CHANGE_TAG_SP";

    public static final String AUTH_CODE_TAG_MODEL = "PD_AUTH_CODE_TAG_MODEL";
    public static final String INSTALL_EVENT_TAG_MODEL = "PD_INSTALL_EVENT_TAG_MODEL";
    public static final String PHARMACY_DATA_TAG_MODEL = "PD_PHARMACY_DATA_TAG_MODEL";
    public static final String USER_DATA_TAG_MODEL = "PD_USER_DATA_TAG_MODEL";
    public static final String PHARMACY_IMAGE_TAG_MODEL = "PD_PHARMACY_IMAGE_TAG_MODEL";
    public static final String NIGHT_MODE_TAG_MODEL = "PD_NIGHT_MODE_TAG_MODEL";
    public static final String LOCATION_TAG_MODEL = "PD_LOCATION_TAG_MODEL";
    public static final String NEARBY_PHARMACIES_TAG_MODEL_OLD = "PD_NEARBY_PHARMACIES_TAG_MODEL_OLD";
    public static final String NEARBY_PHARMACIES_TAG_MODEL = "PD_NEARBY_PHARMACIES_TAG_MODEL";
    public static final String CART_UPDATE_TAG_MODEL = "PD_CART_UPDATE_TAG_MODEL";
    public static final String CART_LIST_TAG_MODEL = "PD_CART_LIST_TAG_MODEL";
    public static final String CART_MESSAGE_TAG_MODEL = "PD_CART_MESSAGE_TAG_MODEL";
    public static final String SELECTED_PHARMACY_TAG_MODEL = "PD_SELECTED_PHARMACY_TAG_MODEL";
    public static final String MOVE_FIND_DATA_TAG_MODEL = "PD_MOVE_FIND_DATA_TAG_MODEL";
    public static final String PHARMACIES_ACTION_TAG_MODEL = "PD_PHARMACIES_ACTION_TAG_MODEL";
    public static final String FCM_TOKEN_TAG_MODEL="PD_FCM_TOKEN";
    public static final String FCM_TOKEN_SENT_TAG_MODEL="PD_FCM_TOKEN_SENT";
    public static final String NOTIFICATIONS_ON_OFF_TAG_MODEL = "PD_NOTIFICATIONS_ON_OFF_TAG_MODEL";
    public static final String VOICE_OVER_ON_OFF_TAG_MODEL = "PD_VOICE_OVER_ON_OFF_TAG_MODEL";
    public static final String PRESCRIPTION_IMAGE_TAG_MODEL = "PD_PRESCRIPTION_IMAGE_TAG_MODEL";
    public static final String NOTIFICATION_TUNE_TAG_MODEL = "PD_NOTIFICATION_TUNE_TAG_MODEL";
    public static final String FIRST_INSTALL_TAG_MODEL = "PD_FIRST_INSTALL_TAG_MODEL";
    public static final String ORDER_COUNT_TAG_MODEL = "PD_ORDER_COUNT_TAG_MODEL";
    public static final String ORDER_COUNT_CHANGE_TAG_MODEL = "PD_ORDER_COUNT_CHANGE_TAG_MODEL";
